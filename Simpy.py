...
def main():
    ...
    parser.add_argument('--bwgs', dest='bwgs', type=str, required=False, nargs=1, help='path to whole genome file in bcf.gz format, with cbi index')
    parser.add_argument('--bimputed', dest='bimputed', type=str, required=False, nargs=1, help='path to imputed file in bcf.gz format, with cbi index')
